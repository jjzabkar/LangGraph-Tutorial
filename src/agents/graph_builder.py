...
from src.agents.soccer_agent_node import soccer_agent_node
...
SOCCER_AGENT_NODE = "soccer_agent_node"
...
graph_builder.add_node(SOCCER_AGENT_NODE, soccer_agent_node)
...
graph_builder.add_conditional_edges(
    ...
    {
        "soccer": SOCCER_AGENT_NODE,
        "therapist": THERAPIST_AGENT_NODE,
        "logical": LOGICAL_AGENT_NODE,
        "music": MUSIC_AGENT_NODE
    }
)
...
graph_builder.add_edge(SOCCER_AGENT_NODE, END)
